...
export default async function EventDetailPage({ params, searchParams }: EventDetailPageProps) {
  ...
  // Optimized: Using a single query with scalar subqueries to fetch event details
  // and counts in one database round-trip, reducing TTFB and improving page load.
