...
export default async function EventDetailPage({ params, searchParams }: EventDetailPageProps) {
  // Parallelizing params, searchParams and getCurrentUser to minimize waterfall latency.
  ...
  // Optimized: Consolidated event details and counts into a single query using scalar subqueries.
  ...
  const { response_count: responseCount, guest_count: guestCount, ...event } = eventData;
