      ...
      <section className="space-y-4">
        ...
        <div>
          ...
          <div className="mt-1 flex justify-between items-start">
            ...
            <p id="title-counter-visual" className="text-xs text-gray-500" aria-hidden="true">
        ...
        <div>
          ...
          <div className="mt-1 flex justify-between items-start">
            ...
            <p id="description-counter-visual" className="text-xs text-gray-500" aria-hidden="true">
