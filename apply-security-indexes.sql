...
-- Organizations: workspaces that own events. Every host gets a personal workspace and existing events are backfilled into it.
...
-- Brand kit: a workspace default brand applied to event pages, emails and SMS.
